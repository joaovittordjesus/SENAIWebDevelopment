...
// Usa o 'useState' para declarar duas variáveis de estado: 'tasks' e
    'newTask'.
        const addTask = () => {
        if (newTask.trim() !== '') {
...
// Define uma função 'deleteTask' que remove uma tarefa com
        base em seu índice na lista.
        setTasks(updatedTasks);
// Atualiza o array 'tasks' com as tarefas restantes, após a
        exclusão.
    };
    return (
        <div>
...
// Renderiza uma lista não ordenada (ul) para exibir as
                    tarefas.
// Usa 'map' para criar um item de lista (li) para cada tarefa
                    no array 'tasks'.
// 'key={index}' é usado para ajudar o React a acompanhar
